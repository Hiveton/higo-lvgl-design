...
const localizedErrorMessages: Record<Locale, Record<string, string>> = {
  "en-US": {
    ...
    JOB_CREATE_FAILED: "Build job create failed",
    JOB_DOWNLOAD_FAILED: "Job download failed",
    JOB_LOOKUP_FAILED: "Job lookup failed",
